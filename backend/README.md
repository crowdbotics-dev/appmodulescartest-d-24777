...
## Project Structure
    ...
    ├── appmodulescartest_d_24777  # Django project configurations
...
1. Clone this repo and `cd appmodulescartest_d_24777`
...
2. Clone this repo and `cd appmodulescartest_d_24777`
